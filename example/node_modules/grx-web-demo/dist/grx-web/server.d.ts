...
export declare function next(ctx: Ctx, index: number | undefined, middlewaredData: Map<string, any> | undefined, req: IncomingMessage, res: ServerResponse): Promise<void>;
